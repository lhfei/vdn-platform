...
<title>${globalTitle}</title>
	...
	<link rel="stylesheet" type="text/css" href="${basePath}/resources/css/cdn/ipserverMonitor/chooser.css" />
	...
	<script type="text/javascript" src="${basePath}/resources/modules/cdn/ipserverMonitor/app.js"></script>
</head>
