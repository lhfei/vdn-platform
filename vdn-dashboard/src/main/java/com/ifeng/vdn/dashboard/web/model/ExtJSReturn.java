...
public class ExtJSReturn {
	public static final String DEFAULT_MESSAGE_NODE = "message";
	public static final String DEFAULT_SUCCESS_NODE = "success";
	public static final String DEFAULT_TOTAL_NODE = "total";
	public static final String DEFAULT_DATA_NODE = "data";
	 ...
	 * @return
	 */
	public static Map<String, Object> mapOK(List<? extends Serializable> beans, ExtJSReturnConfiguration config) {
		
		Map<String, Object> modelMap = new HashMap<String, Object>(3);
		modelMap.put(config.getTotalNode(), beans.size());
		modelMap.put(config.getDataNode(), beans);
		modelMap.put(config.getSuccessNode(), true);
	...
	public static Map<String, Object> mapOK(List<? extends Serializable> beans,
			String nodeName) {
		nodeName = (nodeName != null && nodeName.trim().length() > 0) ? nodeName
				: DEFAULT_DATA_NODE;
