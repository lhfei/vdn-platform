 ...
 * @since Jul 2, 2015
 */
@Component("ipV4Handler")
public class IPV4Handler implements IPAddressHandler {
	
	

	@Override
	public Long toLong(String ipAddress) {
	...
	@Override
	public List<String> getAllFromRange(String start, String end) {
